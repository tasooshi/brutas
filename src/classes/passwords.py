    ...
    def process(self):
        ...
        self.merge(
            ...
            (
                ...
                self.temp('both-tmp-repeat-usernames-all.txt'),
        ...
        self.merge(
            ...
            (
                ...
                self.left(self.temp('simple-usernames-all.txt'), self.base('src/bits/extra-extended.txt')),
...
class BigPasswords(Passwords):
    ...
    def process(self):
        ...
        self.merge(
            ...
            (
                self.both(self.temp('repeat-usernames-all.txt'), self.base('src/bits/extra-all.txt')),
                ...
                self.temp('capitalize-tmp-hax0r-lang-int-extra.txt'),
                self.temp('capitalize-tmp-hax0r-lang-int-extra+extra-basic.txt'),
                self.temp('capitalize-tmp-hax0r-lang-int-extra+extra-extended.txt'),
            ),
            compare=self.temp(self.passwords_all)
        )
